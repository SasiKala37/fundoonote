...
public class LabelController {
	...
	public ResponseEntity<ResponseDTO> renameLabel(@PathVariable("labelId") String labelId,
			@RequestParam String newLabelName, @RequestAttribute("userId") String userId)
	...
	public ResponseEntity<ResponseDTO> removeNoteLabel(@RequestParam String noteId,
			@PathVariable("labelId") String labelId, @RequestAttribute("userId") String userId) throws Exception {
